...
> **Note**
> Everywhere in this repository, make sure to replace `miabbott/ublue-broadcom` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/miabbott/ublue-broadcom/blob/main/scripts/README.md) for more information.
...
```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/miabbott/ublue-broadcom:latest
```

This repository builds date tags as well, so if you want to rebase to a particular day's build:

```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/miabbott/ublue-broadcom:20230403
```
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/miabbott/ublue-broadcom
